...
//     window.history.replaceState(null, '', `/${title}`); // Update URL without hash
//   };
...
//   //           if (active !== nav.id) { // Only update if the active section has changed
//   //             setActive(nav.id);
...
//   // }, [active]); // Add active as a dependency to ensure it updates correctly
//   useEffect(() => {
//     const handleScroll = () => {
